<div class="page-content-wrap">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form class="form-horizontal" method="post" action="<?= base_url('karyawan_save') ?>">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Karyawan</strong> Form Input</h3>
                            ...
                            <div class="panel-body">                                                                        
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Statau Kawin</label>
                                            <div class="col-md-9">                                                                                            
                                        ...
                                        <div class="form-group">                                        
                                            ...
                                            <div class="col-md-9">
                                                <div class="input-group">
                                                   <?php foreach($sk as $j){?>
                                                        <div class="col-md-6">                                    
                                                            <label class="check"><input type="radio"  name="stkrywn" value="<?= $j->id?>"/> <?= $j->nama?></label>
                                                        </div>  
                                                   <?php } ?>
